...
<section style="">
   ...
   <article style="">
      <form method="post" action="twoving.do?command=login" name="loginForm">
            ...
            <div class="auto">
               ...
               <label for="remember" id="remember2" style=" color:gray; font-weight: bold;"> &nbsp;
                  아이디 저장
					...
					var label = document.getElementById("remember2");
         ...
         <div class ="msg"  style="position:relative; top: 40px; font-size:120%;">${message} </div>
         <!-- <input type="submit" class="btn1" value="LOGIN" /> -->
         
         <div class="btn">
            <input type="button" onClick="location.href='twoving.do?command=findIdForm'" class="btn2" value="아이디 찾기 &nbsp;&nbsp;" />
            <p>|</p>
            <input type="button"  onClick="location.href='twoving.do?command=findPwdForm'" class="btn3" value="&nbsp;&nbsp; 비밀번호 찾기" />
         </div>
         <div class="qs">
