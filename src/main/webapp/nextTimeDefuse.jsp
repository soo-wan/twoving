	...
	<article>
		...
		<div class="defuse">
			...
			<div class="defuse-bottom">
				<input type="button" value="정기결제 해지하러 가기" style="background-color:white; font-size: 120%; font-weight: bold;" size="150" onClick="location.href='twoving.do?command=passTicket'">
			</div>
		</div>
